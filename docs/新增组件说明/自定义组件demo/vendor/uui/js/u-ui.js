...
u.extend(u, {
	...
	closest: function(element, selector) {
		var tmp = element;
		while(!u.hasClass(tmp, selector)&& tmp != document.body) {
		  tmp = tmp.parentNode;
		}
...
u.NavLayout = u.BaseComponent.extend({
    ...
    _navlinkClickHander: function (e) {
        var curlink = e.currentTarget.querySelector('.'+this._CssClasses.NAV_LINK_CURRENT);
...
u.DateTimePicker.fn._fillTime = function(type){
   ...
   // tempDate = this.startDate;
    ...
    if(u.isIE8){ //IE8保持原来，非IE8使用clockpicker
        ...
        timetemplate += '  <div class="clockpicker-plate" style="left:35px;">';
        timetemplate += '      <div class="clockpicker-canvas">';
        timetemplate += '          <svg class="clockpicker-svg" width="200" height="200">';
        ...
        timetemplate += '          <div class="clockpicker-tick" style="left: 87px; top: 7px;">00</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 114px; top: 40.2346px; font-size: 120%;">1</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 133.765px; top: 60px; font-size: 120%;">2</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 141px; top: 87px; font-size: 120%;">3</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 133.765px; top: 114px; font-size: 120%;">4</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 114px; top: 133.765px; font-size: 120%;">5</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 87px; top: 141px; font-size: 120%;">6</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 60px; top: 133.765px; font-size: 120%;">7</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 40.2346px; top: 114px; font-size: 120%;">8</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 33px; top: 87px; font-size: 120%;">9</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 40.2346px; top: 60px; font-size: 120%;">10</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 60px; top: 40.2346px; font-size: 120%;">11</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 87px; top: 33px; font-size: 120%;">12</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 127px; top: 17.718px;">13</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 156.282px; top: 47px;">14</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 167px; top: 87px;">15</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 156.282px; top: 127px;">16</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 127px; top: 156.282px;">17</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 87px; top: 167px;">18</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 47px; top: 156.282px;">19</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 17.718px; top: 127px;">20</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 7px; top: 87px;">21</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 17.718px; top: 47px;">22</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 47px; top: 17.718px;">23</div>';
        timetemplate += '      </div>';
        timetemplate += '      <div class="clockpicker-dial clockpicker-minutes" style="visibility: hidden;">';
        timetemplate += '          <div class="clockpicker-tick" style="left: 87px; top: 7px; font-size: 120%;">00</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 127px; top: 17.718px; font-size: 120%;">05</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 156.282px; top: 47px; font-size: 120%;">10</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 167px; top: 87px; font-size: 120%;">15</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 156.282px; top: 127px; font-size: 120%;">20</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 127px; top: 156.282px; font-size: 120%;">25</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 87px; top: 167px; font-size: 120%;">30</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 47px; top: 156.282px; font-size: 120%;">35</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 17.718px; top: 127px; font-size: 120%;">40</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 7px; top: 87px; font-size: 120%;">45</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 17.718px; top: 47px; font-size: 120%;">50</div>';
        timetemplate += '          <div class="clockpicker-tick" style="left: 47px; top: 17.718px; font-size: 120%;">55</div>';
        timetemplate += '      </div>';
