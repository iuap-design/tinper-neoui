...
import { on, off, trigger, stopEvent } from 'tinper-sparrow/src/event';
import { addClass, removeClass, hasClass, closest, makeDOM, makeModal, showPanelByEle, getElementLeft, getElementTop } from 'tinper-sparrow/src/dom';
import { core } from 'tinper-sparrow/src/core';
import { date as udate } from 'tinper-sparrow/src/util/dateUtils';
import { Validate } from './neoui-validate';
import { URipple } from 'tinper-sparrow/src/util/ripple';
import { dateFormat } from 'tinper-sparrow/src/util';
...
DateTimePicker.fn._fillMonth = function () {
    ...
    '<div class="u-date-content-title-date"></div>',
    '<div class="u-date-content-title-time"></div>',*/
    '</div>', '<div class="u-date-content-panel">', '<div class="u-date-content-year-cell">' + udate._jsonLocale.monthsShort[0] + '</div>', '<div class="u-date-content-year-cell">' + udate._jsonLocale.monthsShort[1] + '</div>', '<div class="u-date-content-year-cell">' + udate._jsonLocale.monthsShort[2] + '</div>', '<div class="u-date-content-year-cell">' + udate._jsonLocale.monthsShort[3] + '</div>', '<div class="u-date-content-year-cell">' + udate._jsonLocale.monthsShort[4] + '</div>', '<div class="u-date-content-year-cell">' + udate._jsonLocale.monthsShort[5] + '</div>', '<div class="u-date-content-year-cell">' + udate._jsonLocale.monthsShort[6] + '</div>', '<div class="u-date-content-year-cell">' + udate._jsonLocale.monthsShort[7] + '</div>', '<div class="u-date-content-year-cell">' + udate._jsonLocale.monthsShort[8] + '</div>', '<div class="u-date-content-year-cell">' + udate._jsonLocale.monthsShort[9] + '</div>', '<div class="u-date-content-year-cell">' + udate._jsonLocale.monthsShort[10] + '</div>', '<div class="u-date-content-year-cell">' + udate._jsonLocale.monthsShort[11] + '</div>', '</div>', '</div>'].join("");
...
DateTimePicker.fn._fillDate = function (type) {
    ...
    if ('current' === type) {
        ...
        tempDate = udate.add(this.endDate, 'd', 8);
        // 默认显示每个月的1号
        tempDate = udate.getDateObj(tempDate.setDate(1));
    }
