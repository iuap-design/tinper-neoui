...
var doValidate = function doValidate(element) {
    ...
    each(childEle, function (i, child) {
        if (child['Validate'] && child['Validate'].check) {
            ...
            if ((typeof result === 'undefined' ? 'undefined' : babelHelpers['typeof'](result)) === 'object') passed = result['passed'] && passed;else passed = result && passed;
        }
    });
    return passed;
};
...
export { Validate, validate, doValidate };