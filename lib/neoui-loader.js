 ...
 */
import { makeDOM, makModalAssign, addClass } from 'tinper-sparrow/src/dom';
...
var showLoader = function showLoader(options) {
	...
	if (hasback) {
		var overlayDiv = makModalAssign(templateDom, parEle);
	}
...
var hideLoader = function hideLoader(options) {
	...
	try {
		var overlayDivs = document.querySelectorAll('.u-overlay-assign.u-loader-back');
