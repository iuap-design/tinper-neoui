...
import { addClass, removeClass, hasClass, showPanelByEle, makeDOM, makeModal, getZIndex } from 'tinper-sparrow/src/dom';
import { on, off } from 'tinper-sparrow/src/event';
import { isMobile, env } from 'tinper-sparrow/src/env';
...
var ClockPicker = u.BaseComponent.extend({
    ...
    createPanel: function createPanel() {
        ...
        if (!isMobile) this.btnClean.style.display = 'none';
